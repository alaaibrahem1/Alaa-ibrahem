...
const cards = [
  {
    ...
    content: () => {
      return (
        ...
        developing high-performance web applications. With a strong
        foundation in Next.js, TypeScript, JavaScript, React, and Tailwind CSS, 
        I focus on crafting seamless and responsive user experiences.
        <br /> <br />
        In my role, I focus on:
        <br />
        <br />
        Front-end Development: Building intuitive, interactive, and 
        accessible interfaces using React and Next.js, ensuring optimal 
  ...
  },
  {
    ...
    content: () => {
      return (
        <p>
        UI/UX Optimization: Enhancing user interfaces with modern design principles
        and ensuring seamless interactions through responsive layouts.
        <br />
        <br />
        Passionate about creating visually appealing and efficient web applications,
        I strive to deliver engaging digital experiences that align with user needs. 
        Let’s connect and collaborate on building outstanding front-end solutions!
      </p>
      )
    },
  },
